...
Router.map(function() {
  ...
  this.route('index', {
    ...
    template: 'mapMain',
    waitOn: function () {
      return [Meteor.subscribe('naps'), Meteor.subscribe('spot_types'), Meteor.subscribe('currentUser')];
    },
  ...
  this.route('addingNap', {
    ...
    waitOn: function () {
      return [Meteor.subscribe('naps'), Meteor.subscribe('spot_types')];
    },
    onRun:function(){
